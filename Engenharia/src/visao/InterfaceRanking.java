...
public class InterfaceRanking extends JFrame {
	...
	public InterfaceRanking(final Jogador jogador_logado) {
		...
		if (listaJogadores.size() > 0)
			icon1 = new JLabel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(listaJogadores.get(0).getIcone()))));
		...
		if (listaJogadores.size() > 0)
			vitorias1 = new JLabel("Vitórias: " + listaJogadores.get(0).getPartidas_vencidas());
		...
		if (listaJogadores.size() > 0)
			ponto1 = new JLabel("Pontuação: " + listaJogadores.get(0).getPontuacao());
		...
		if (listaJogadores.size() > 0)
			tempo1 = new JLabel("Tempo: " + formatTime(listaJogadores.get(0).getTempo_rodadas()));
		...
		if (listaJogadores.size() > 0)
			data1 = new JLabel("Data: " + listaJogadores.get(0).getUltima_partida());
		...
		if (listaJogadores.size() > 0)
			name1 = new JLabel(listaJogadores.get(0).getNome());
		...
		if (listaJogadores.size() > 1)
			icon2 = new JLabel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(listaJogadores.get(1).getIcone()))));
		...
		if (listaJogadores.size() > 1)
			vitorias2 = new JLabel("Vitórias: " + listaJogadores.get(1).getPartidas_vencidas());
		...
		if (listaJogadores.size() > 1)
			ponto2 = new JLabel("Pontuação: " + listaJogadores.get(1).getPontuacao());
		...
		if (listaJogadores.size() > 1)
			tempo2 = new JLabel("Tempo: " + formatTime(listaJogadores.get(1).getTempo_rodadas()));
		...
		if (listaJogadores.size() > 1)
			data2 = new JLabel("Data: " + listaJogadores.get(1).getUltima_partida());
		...
		if (listaJogadores.size() > 1)
			name2 = new JLabel(listaJogadores.get(1).getNome());
		...
		if (listaJogadores.size() > 2)
			icon3 = new JLabel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(listaJogadores.get(2).getIcone()))));
		...
		if (listaJogadores.size() > 2)
			vitorias3 = new JLabel("Vitórias: " + listaJogadores.get(2).getPartidas_vencidas());
		...
		if (listaJogadores.size() > 2)
			ponto3 = new JLabel("Pontuação: " + listaJogadores.get(2).getPontuacao());
		...
		if (listaJogadores.size() > 2)
			tempo3 = new JLabel("Tempo: " + formatTime(listaJogadores.get(2).getTempo_rodadas()));
		...
		if (listaJogadores.size() > 2)
			data3 = new JLabel("Data: " + listaJogadores.get(2).getUltima_partida());
		...
		if (listaJogadores.size() > 2)
			name3 = new JLabel(listaJogadores.get(2).getNome());
		...
		if (listaJogadores.size() > 3)
			icon4 = new JLabel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(listaJogadores.get(3).getIcone()))));
		...
		if (listaJogadores.size() > 3)
			vitorias4 = new JLabel("Vitórias: " + listaJogadores.get(3).getPartidas_vencidas());
		...
		if (listaJogadores.size() > 3)
			ponto4 = new JLabel("Pontuação: " + listaJogadores.get(3).getPontuacao());
		...
		if (listaJogadores.size() > 3)
			tempo4 = new JLabel("Tempo: " + formatTime(listaJogadores.get(3).getTempo_rodadas()));
		...
		if (listaJogadores.size() > 3)
			data4 = new JLabel("Data: " + listaJogadores.get(3).getUltima_partida());
		...
		if (listaJogadores.size() > 3)
			name4 = new JLabel(listaJogadores.get(3).getNome());
		...
		if (listaJogadores.size() > 4)
			icon5 = new JLabel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(listaJogadores.get(4).getIcone()))));
		...
		if (listaJogadores.size() > 4)
			vitorias5 = new JLabel("Vitórias: " + listaJogadores.get(4).getPartidas_vencidas());
		...
		if (listaJogadores.size() > 4)
			ponto5 = new JLabel("Pontuação: " + listaJogadores.get(4).getPontuacao());
		...
		if (listaJogadores.size() > 4)
			tempo5 = new JLabel("Tempo: " + formatTime(listaJogadores.get(4).getTempo_rodadas()));
		...
		if (listaJogadores.size() > 4)
			data5 = new JLabel("Data: " + listaJogadores.get(4).getUltima_partida());
		...
		if (listaJogadores.size() > 4)
			name5 = new JLabel(listaJogadores.get(4).getNome());
		...
		resetarBt.setDisabledSelectedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-disabled.png"))));
		resetarBt.setRolloverSelectedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-rollover.png"))));
		resetarBt.setRolloverIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-rollover.png"))));
		resetarBt.setPressedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-pressed.png"))));
		resetarBt.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-normal.png"))));
		resetarBt.setDisabledIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-resetar-disabled.png"))));
		...
		pdfBt.setDisabledSelectedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-disabled.png"))));
		pdfBt.setRolloverSelectedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-rollover.png"))));
		pdfBt.setRolloverIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-rollover.png"))));
		pdfBt.setPressedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-pressed.png"))));
		pdfBt.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-normal.png"))));
		pdfBt.setDisabledIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/graphics/BtP-gerar-disabled.png"))));
